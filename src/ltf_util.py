...
class LTF_util(object):
    ...
    def get_original_text(self, offset_str):
        docid, start, end = self.parse_offset_str(offset_str)
...
if __name__ == '__main__':
    ...
    print(ltf_util.get_context('K0C047Z59:477-493'))
    print(ltf_util.get_original_text('K0C047Z59:477-493'))
    # print(ltf_util.get_str_inside_sent('K0C047Z59:58-69'))
    # print(ltf_util.get_expand_text('K0C047Z59:58-69',2))
    # print(ltf_util.get_expand_text('K0C047Z57:1-4', 2))